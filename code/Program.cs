...
namespace ICMP {
	class Program {
		...
		static void Main(string[] args) {
            ...
            Console.WriteLine($"{new string('-', 10)} Test ping {new string('-', 10)}\r\n");
            request = new IcmpRequest(new CmdRequestInfo("www.google.com", "Hello", CmdType.ping, 4, 32, 1000, 1000, 128));

            Console.WriteLine($"{new string('-', 10)} Test ping {new string('-', 10)}\r\n");
            request = new IcmpRequest(new CmdRequestInfo("www.rambler.com", "Hello", CmdType.ping, 4, 32, 1000, 1000, 128));

            Console.WriteLine($"{new string('-', 10)} Test ping {new string('-', 10)}\r\n");
            request = new IcmpRequest(new CmdRequestInfo("www.habr.com", "Hello", CmdType.ping, 4, 32, 1000, 1000, 128));
